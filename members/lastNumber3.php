...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="container">
                <h1 class="display-4 text-white mt-3">เลข 3 ตัว</h1>
              ...
              <div class="col-12  mx-auto">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row mt-1">
                        <div class="col">
                          <p class="winnertext" style="margin-bottom: 0px; ">สูตร ที่1 95%</p>
                        </div>
                      </div>
                    <div class="row">
                      <div class="col">
                    ...
                    <div class="row">
                      <div class="col form-group input-group-lg">
                          <h1 id="winnertext1"class="display-4 winnerno">522</h1>
                      </div>
                    </div>
                    <div class="row">
              ...
              <div class="col-12 mx-auto">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row mt-1">
                          <div class="col">
                            <p class="winnertext" style="margin-bottom: 0px;">สูตรที่2 35%</p>
                          </div>
                        </div>
                      <div class="row">
                        <div class="col">
                      ...
                      <div class="row">
                        <div class="col form-group input-group-lg">
                            <h1 id="winnertext2"class="display-4 winnerno">425</h1>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col form-group">
                ...
                <div class="col-12 me-auto">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row mt-1">
                            <div class="col">
                              <p class="winnertext" style="margin-bottom: 0px;">สูตรที่3 85%</p>
                            </div>
                          </div>
                        <div class="row">
                          <div class="col">
                        ...
                        <div class="row">
                          <div class="col form-group input-group-lg">
                              <h1 id="winnertext3"class="display-4 winnerno">687</h1>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col form-group">
