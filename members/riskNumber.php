              ...
              <div class="col-12  mx-auto">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row mt-1">
                        <div class="col">
                          <p class="winnertext" style="margin-bottom: 0px; ">3 ตัวบน</p>
                        </div>
                      </div>
                    <div class="row">
                      <div class="col">
                    ...
                    <div class="row">
                      <div class="col form-group input-group-lg">
                          <h1 id="winnertext1"class="display-4 winnerno">000</h1>
                      </div>
                    </div>
                    <div class="row">
              ...
              <div class="col-12 mx-auto">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row mt-1">
                          <div class="col">
                            <p class="winnertext" style="margin-bottom: 0px;">เลขท้าย 2 ตัว</p>
                          </div>
                        </div>
                      <div class="row">
                        <div class="col">
                      ...
                      <div class="row">
                        <div class="col form-group input-group-lg">
                            <h1 id="winnertext2"class="display-4 winnerno">00</h1>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col form-group">
