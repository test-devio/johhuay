...
<body>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="container">
                <h1 class="display-4 text-white mt-3">เลขท้าย 2 ตัว</h1>
              ...
              <div class="col-12  mx-auto">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <img id="img1" src="assets/images/Logo.png" width="150px" class="img-fluid p-1">
                      </div>
                    </div>
                    <div class="row mt-1">
                        <div class="col">
                          <p class="winnertext" style="margin-bottom: 0px; ">สูตร ที่1 45%</p>
                        </div>
                      </div>
                    <div class="row">
                      <div class="col">
                    ...
                    <div class="row">
                      <div class="col form-group input-group-lg">
                          <h1 id="winnertext1"class="display-4 winnerno">75</h1>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col form-group">
                        <!-- <button id="btn1" type="button" class="btn btn-lg btn-block btn-success"
                          onclick="fn(1)">สุ่มเลข</button> -->
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-12 mx-auto">
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <img id="img2" src="assets/images/Logo.png" width="150px" class="img-fluid p-1">
                        </div>
                      </div>
                      <div class="row mt-1">
                          <div class="col">
                            <p class="winnertext" style="margin-bottom: 0px;">สูตรที่2 65%</p>
                          </div>
                        </div>
                      <div class="row">
                        <div class="col">
                      ...
                      <div class="row">
                        <div class="col form-group input-group-lg">
                            <h1 id="winnertext2"class="display-4 winnerno">35</h1>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col form-group">
                          <!-- <button id="btn2" type="button" class="btn btn-lg btn-block btn-success"
                            onclick="fn(2)">สุ่มเลข</button> -->
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-12 me-auto">
                    <div class="card">
                      <div class="card-body">
                        <div class="row">
                          <div class="col">
                            <img id="img3" src="assets/images/Logo.png" width="150px" class="img-fluid p-1">
                          </div>
                        </div>
                        <div class="row mt-1">
                            <div class="col">
                              <p class="winnertext" style="margin-bottom: 0px;">สูตรที่3 75%</p>
                            </div>
                          </div>
                        <div class="row">
                          <div class="col">
                        ...
                        <div class="row">
                          <div class="col form-group input-group-lg">
                              <h1 id="winnertext3"class="display-4 winnerno">93</h1>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col form-group">
                            <!-- <button id="btn3" type="button" class="btn btn-lg btn-block btn-success"
                              onclick="fn(3)">สุ่มเลข</button> -->
                          </div>
                        </div>
                      </div>
                    </div>
